# Function to embed multiple files into a header as a map of filename -> content
function(embed_map)
    # Parse arguments
    set(options)
...
")
    ...
    file(APPEND "${generator_script}" "
file(APPEND \"${EMBED_OUTPUT_HEADER}\" \"const std::map<std::string, const char*> ${const_name} = {\\n\")
")
...
file(APPEND \"${EMBED_OUTPUT_HEADER}\" \"    {\\\"${file_name}\\\", \\\"\${file_content}\\\"},\\n\")
")
    endforeach()
